...
const IconDemo = () => {
    ...
    const IconEmail = createIcon({
      ...
      const IconFont = createFromIconfont('//at.alicdn.com/t/c/font_2679150_i3n0jix2v3e.js')

      return <div style={{padding: "50px"}}>
        <p>createIcon展示</p>
        <IconAdd size="40px"/>
        <IconEmail style={{color: "blue", fontSize: "36px"}} spin/>
        <p>加载iconfont图标</p>
        <IconFont type="icon-cangshu" size="36px"></IconFont>
        <IconFont type="icon-chaiquan" size="36px"></IconFont>
      </div>
}
